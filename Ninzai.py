...
\033[1;96m«-----------------\033[1;91MmSAQIKAKA\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
B = '\033[1;94m'
...
def mafia():
	...
	if black =="":
		...
		love("Now you can open this tool as usual")
		love("\033[1;93mTool User Name SAQI Password KAKA")
                time.sleep(5)
		...
		love("\033[1;93mTool User Name SAQI Password KAKA")
	        ...
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name\033[1;92m SAQI\033[1;93m Password \033[1;92mKAKA")
                time.sleep(6)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/lov3Hak3r")
                print (logo)
		love("\033[1;96mCongratulations SAQIKAKA Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
	        ...
	        love("Now you can open this tool as usual")
                love("\033[1;95mTool User Name SAQI  Password KAKA")
                time.sleep(5)
	        ...
	        love("Now you can open this tool as usual")
                love("\033[1;96mTool User Name SAQI  Password KAKA")
                time.sleep(5)
		...
		love("Now you can open this tool as usual")
                love("\033[1;92mTool User Name SAQI Password KAKA")
		time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/Black_Mafia")
                print (logo)
	        love("\033[1;93mCongratulations SAQI_KAKA Payload Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/Logo")
                print (logo)
		love("\033[1;96mCongratulations Saqikaka Logo  Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/World")
                print (logo)
		love("\033[1;96mCongratulations SAQILAKA Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
